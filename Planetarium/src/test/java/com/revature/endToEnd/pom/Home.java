package com.revature.endToEnd.pom;
...
public class Home {
    ...
    public Home() {
        // fields can be searched by following the name of the field, could be useful for reducing code
        // Elements are also re-searched every time they're called. Using this would remove redundancies
